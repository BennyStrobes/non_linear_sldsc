...
# Downloaded from https://hgdownload.cse.ucsc.edu/goldenpath/hg19/chromosomes/
reference_genome_fasta_dir="/n/groups/price/ben/non_linear_sldsc/input_data/hg19_fasta/"
...
# Output root
output_root_scratch="/n/scratch/users/b/bes710/non_linear_sldsc/"
...
if false; then
sh preprocess_data_for_non_linear_sldsc.sh $ukbb_preprocessed_for_genome_wide_susie_dir $ldsc_baseline_ld_hg19_annotation_dir $preprocessed_data_for_non_linear_sldsc_dir $trait_name $reference_genome_fasta_dir
fi
...
ld_type="in_sample_ld"
learn_intercept=( "learn_intercept" )
learning_rate="0.001"

if false; then
learning_rate="0.0001"
model_type="sequence_conv_neural_net_delta"
...
if false; then
learning_rate="0.0001"
model_type="sequence_conv_neural_net_calibrated_delta"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_linearly_calibrated_delta"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_nn_combine_sequences"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
fi
...
########################################
# Run non-linear S-LDSC analysis (OLD)
########################################
trait_name="blood_WHITE_COUNT"
samp_size="326723"
training_chromosomes="all"
...
model_type_arr=("sequence_conv_neural_net" "deep_neural_network_no_drops" "neural_network_10" "neural_network_20" "neural_network_30" "neural_network_no_drops" "linear_model" "exp_linear_model" "intercept_model")
if false; then
...
if false; then
learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

model_type="sequence_conv_neural_net_w_indicator"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

model_type="sequence_conv_neural_net_big"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
fi

if false; then
learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_3_1"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
fi

if false; then
learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_3_2"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_3_3"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_3_4"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_4_1"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_4_2"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_4_3"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_4_4"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_5_1"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_5_2"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_5_3"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
fi
if false; then
learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_5_4"
sh run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

fi


learning_rate="0.0001"
model_type="sequence_conv_neural_net_michael1"
if false; then
sh run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
fi
if false; then
learning_rate="0.0001"
model_type="sequence_conv_neural_net_michael2"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_michael3"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
fi
if false; then
learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_michael1"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
fi
if false; then
learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_michael2"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

learning_rate="0.0001"
model_type="sequence_conv_neural_net_w_point_mutation_michael3"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
fi
...
if false; then
learning_rate="0.0001"
model_type="deep_neural_network_20"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

model_type="deep_neural_network_40"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate

model_type="deep_neural_network_60"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
fi
...
if false; then
learning_rate="0.0001"
model_type="deep_neural_network_10"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate



learning_rate="0.0001"
model_type="deep_neural_network_05"
sbatch run_non_linear_sldsc_marginal_updates.sh $trait_name $preprocessed_data_for_non_linear_sldsc_dir $non_linear_sldsc_results_dir $model_type $samp_size $training_chromosomes $evaluation_chromosomes $ld_type $learn_intercept $learning_rate
fi
