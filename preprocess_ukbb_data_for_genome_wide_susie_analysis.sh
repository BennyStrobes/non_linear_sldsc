...
python3 preprocess_ukbb_data_for_genome_wide_susie_analysis.py $chrom_num $genome_wide_window_file $ukbb_sumstats_hg38_dir $ref_1kg_genotype_dir $ukbb_preprocessed_for_genome_wide_susie_dir
